...
function Case4(props) {
  ...
  var onClicked = function onClicked() {
    if (inputN < 0) {
      ...
      setResult(Object(_Fibonacci__WEBPACK_IMPORTED_MODULE_4__["fibonacci"])(inputN).slice(0, 1).join(', '));
    } else {
