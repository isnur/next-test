...
function Case4(props) {
  ...
  var onClicked = function onClicked() {
    if (inputN < 0) {
      setResult('You must enter a value start from zero');
    } else if (inputN === 0) {
