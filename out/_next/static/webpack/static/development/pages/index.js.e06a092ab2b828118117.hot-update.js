...
function Case1(props) {
  ...
  var onChanged = function onChanged(id, val) {
    console.log('val', val);
    console.log('val2', val.replace(/^00+/, ''));
    id === 'X' ? setInputX(val.replace(/^00+/, '')) : setInputY(val.replace(/^00+/, ''));
  };
